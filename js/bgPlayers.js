...
btn1.textContent = "Max 2 Players"
btn1.addEventListener('click', () => {
    const array1 = bgGameData.filter(bgGameData => bgGameData.maxPlayers === 2)
...
btn2.textContent = "Max 4 Players"
btn2.addEventListener('click', () => {
    const array2 = bgGameData.filter(bgGameData => bgGameData.maxPlayers <= 4)
...
btn3.textContent = "Max 5 Players"
btn3.addEventListener('click', () => {
    const array3 = bgGameData.filter(bgGameData => bgGameData.maxPlayers <= 5)
...
btn4.textContent = "Max 6 Players"
btn4.addEventListener('click', () => {
    const array4 = bgGameData.filter(bgGameData => bgGameData.maxPlayers === 6)
...
btn5.textContent = "7+ Players"
btn5.addEventListener('click', () => {
    const array5 = bgGameData.filter(bgGameData => bgGameData.maxPlayers >= 7)
