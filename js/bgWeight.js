...
btn1.textContent = "Light - 1"
btn1.addEventListener('click', () => {
    const array1 = bgGameData.filter(bgGameData => bgGameData.weight === 1)
...
btn2.textContent = "Medium - 2"
btn2.addEventListener('click', () => {
    const array2 = bgGameData.filter(bgGameData => bgGameData.weight === 2)
...
btn3.textContent = "Somewhat Heavy - 3"
btn3.addEventListener('click', () => {
    const array3 = bgGameData.filter(bgGameData => bgGameData.weight === 3)
...
btn4.textContent = "Heavy - 4"
btn4.addEventListener('click', () => {
    const array4 = bgGameData.filter(bgGameData => bgGameData.weight === 4)
...
btn5.textContent = "Very Heavy - 5"
btn5.addEventListener('click', () => {
    const array5 = bgGameData.filter(bgGameData => bgGameData.weight === 5)
